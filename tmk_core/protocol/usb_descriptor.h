...
typedef struct {
    ...
    // Second joystick HID Interface
    USB_Descriptor_Interface_t Joystick2_Interface;
    USB_HID_Descriptor_HID_t   Joystick2_HID;
    USB_Descriptor_Endpoint_t  Joystick2_INEndpoint;
#endif

...
// clang-format on
    ...
    [USB_ENDPOINT_IN_JOYSTICK2] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, JOYSTICK2_EPSIZE, JOYSTICK2_IN_EPNUM, JOYSTICK2_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(sizeof(report_joystick2_t))),
#endif
...
#ifdef JOYSTICK2_ENABLE
    [JOYSTICK2_INTERFACE] = USB_ENDPOINT_IN_JOYSTICK2,
#endif
